...
class RLHFArguments:
    ...
    save_ppo_stats: bool = field(
        default=False,
        metadata={"help": "Whether or not to save the PPO stats."},
    )
    ppo_stats_save_interval: int = field(
        default=500,
        metadata={"help": "The interval to save the PPO stats."},
    )
    ppo_stats_log_interval: int = field(
        default=10,
        metadata={"help": "The interval to log the PPO stats."},
    )
    init_kl_coef: float = field(
        default=0.2,
        metadata={"help": "The initial KL coefficient for PPO training."},
    )
    gamma: float = field(
        default=1,
        metadata={"help": "The discount factor for PPO training."},
    )
    lam: float = field(
        default=0.95,
        metadata={"help": "The lambda parameter for PPO training."},
    )
    kl_penalty: Literal["kl", "mse"] = field(
        default="kl",
        metadata={"help": "The type of KL penalty to use for PPO training."},
    )
    ...
    custom_reward_model: bool = field(
        default=False,
        metadata={"help": "Whether or not to use the custom reward model."},
    )
...
class FinetuningArguments(
    ...
    eval_exact_match: bool = field(
        default=False,
        metadata={"help": "Whether or not to compute exact match."},
    )
