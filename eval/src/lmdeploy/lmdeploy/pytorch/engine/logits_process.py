...
import torch
try:
    from transformers.generation.logits_process import LogitsWarper  # old HF
except ImportError:
    from transformers.generation.logits_process import LogitsProcessor as LogitsWarper  # new HF
